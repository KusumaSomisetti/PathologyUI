...
export default function LeftPanel({
  ...
  const Hamburger = (
    <button
      ...
      // stop the same pointer event from hitting the backdrop
      onMouseDown={(e) => {
        e.stopPropagation();
        setDrawerOpen(true);
      }}
      className="xl:hidden fixed z-[3000] inline-flex items-center justify-center rounded-md border border-gray-300 bg-white/90 backdrop-blur px-2.5 py-2 shadow"
      style={{
        // left-most corner with safe-area support
